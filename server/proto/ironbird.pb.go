...
type ChainConfig struct {
	...
	CustomProviderConfig  string                 `protobuf:"bytes,13,opt,name=custom_provider_config,json=customProviderConfig,proto3" json:"custom_provider_config,omitempty"`
...
func (x *ChainConfig) GetCustomProviderConfig() string {
	if x != nil {
		return x.CustomProviderConfig
	}
	return ""
}
...
const file_server_proto_ironbird_proto_rawDesc = "" +
	...
	"numOfNodes\x12*\n" +
	"\x11num_of_validators\x18\x03 \x01(\x04R\x0fnumOfValidators\"\xd4\x04\n" +
	...
	"\x14custom_client_config\x18\b \x01(\tR\x12customClientConfig\x124\n" +
	"\x16custom_provider_config\x18\r \x01(\tR\x14customProviderConfig\x12\"\n" +
...
var file_server_proto_ironbird_proto_depIdxs = []int32{
	...
	2,  // 2: skip.ironbird.ChainConfig.region_configs:type_name -> skip.ironbird.RegionConfig
